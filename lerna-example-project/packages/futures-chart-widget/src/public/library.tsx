...
import { FuturesChart } from "../ui/widgets";
import { BehaviorSubject } from "rxjs";
import { ERRORS } from "../constants";
import { SymbolConfig } from "../interfaces";
import { Units, ChartInterval, ChartType, FuturesSymbol } from "../types";
...
export type CreateFuturesChartWidget = WidgetFactory<WidgetConfig, ThemeProp, Promise<PublicApi>>;

export const createFuturesChartWidget: CreateFuturesChartWidget = async ({
  container,
  apiKey,
  ...
  let component: any;
  let rootComponent = <FuturesChart ref={x => (component = x)} theme={theme} />;
