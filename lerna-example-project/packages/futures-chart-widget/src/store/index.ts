...
import { Quote, SymbolPriceHistory, HistoricPrice } from "../interfaces";
import { ChartType, ChartInterval, FuturesSymbol } from "../types";
...
export interface PublicApiCallbacks {
  ...
  readonly chartDataDidChange?: (chartData: ReadonlyArray<HistoricPrice>) => void;
