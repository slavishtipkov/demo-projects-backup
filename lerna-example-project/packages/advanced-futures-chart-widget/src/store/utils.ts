import { SymbolPriceHistory } from "../interfaces";
...
export const normalizeApiResponse = (data: any): SymbolPriceHistory => {
  data.historicPrices = data.historicPrices.map((h: any) => {
    return {
