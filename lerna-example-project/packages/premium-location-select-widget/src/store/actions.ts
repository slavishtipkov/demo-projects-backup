...
export const enum ActionTypes {
  ...
  SET_LOCATION_SELECT_ERROR_MESSAGE = "SET_LOCATION_SELECT_ERROR_MESSAGE",
...
export interface SetErrorMessageAction extends Action<ActionTypes> {
  readonly type: ActionTypes.SET_LOCATION_SELECT_ERROR_MESSAGE;
  readonly payload: Error;
  readonly error?: boolean;
}

export const setErrorMessageAction: ActionCreator<SetErrorMessageAction> = (error: string) => ({
  type: ActionTypes.SET_LOCATION_SELECT_ERROR_MESSAGE,
